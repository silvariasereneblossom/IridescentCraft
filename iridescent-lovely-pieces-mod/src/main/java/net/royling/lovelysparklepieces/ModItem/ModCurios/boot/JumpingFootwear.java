...
public class JumpingFootwear extends UniversalCurio {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        tooltipComponents.add(Component.translatable("tooltip.lovely_sparkle_pieces.jumping.basic").withStyle(ChatFormatting.GOLD));
        tooltipComponents.add(Component.translatable("tooltip.lovely_sparkle_pieces.jumping.des2").withStyle(ChatFormatting.GOLD));
