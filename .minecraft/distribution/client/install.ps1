...
foreach ($syncFile in @('sync_client.ps1', 'sync_client.bat', 'download_mods.ps1', 'cleanup_stale_jars.ps1', 'gen_pwpack.ps1', 'packwiz-installer-bootstrap.jar', 'packwiz-installer.jar')) {
