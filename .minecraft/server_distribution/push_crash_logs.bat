...
set "REMOTE_DEST=Z:\Users\silvariazemaitis\IridescentcraftDev\IridescentCraft\.minecraft\server_distribution\TesterLogs\Server Logs"
...
set "REPO_ROOT=Z:\Users\silvariazemaitis\IridescentcraftDev\IridescentCraft\.minecraft\server_distribution"
if exist "%REPO_ROOT%" (
