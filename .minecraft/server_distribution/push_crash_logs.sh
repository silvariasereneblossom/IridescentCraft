...
# is local.
REMOTE_DEST="${REMOTE_DEST:-/z/Users/silvariazemaitis/IridescentcraftDev/IridescentCraft/.minecraft/server_distribution/TesterLogs/Server Logs}"
REMOTE_ROOT="${REMOTE_ROOT:-/z/Users/silvariazemaitis/IridescentcraftDev/IridescentCraft/.minecraft/server_distribution}"
