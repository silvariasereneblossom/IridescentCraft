...
CUSTOM_JARS="iridescent_classes.jar|iridescent_codex_data.jar|iridescent_origins-1.0.0.jar|mek_walkable_cables-1.0.1.jar|offlineskins-1.20.1-v1.jar|zeta_racefix-1.0.0.jar|Patchouli-1.20.1-85-FORGE.jar|ars_nouveau-1.20.1-4.12.7-all.jar"
