...
| 13 | [long-tail magic + boss mods batch](long_tail_magic_and_bosses.md) (24 mods) | **MEDIUM REWORK** | 2026-04-27 | 3 high-impact ungated mods surfaced: **art_of_forging (22 items, 0 refs)**, **too_many_bows (31 items including 14 EPIC bows, 0 refs)**, **moreartifacts (32 items, 2 refs)**. Existing coverage solid for relics/artifacts/mahoutsukai/stalwart_dungeons. ~85 progression-relevant items completely ungated. |
