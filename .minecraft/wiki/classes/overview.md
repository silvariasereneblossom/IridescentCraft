...
| Faefolk | +30% magic damage, +10% mana regen, +10% speed, slow fall | -20% melee damage, -50% armor toughness (only when wearing any non-light armor — full robes bypass), -15% HP |
