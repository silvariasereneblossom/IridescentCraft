 ...
 *
 * The wand has its own variant of this in WandMaterialIndexProperty
 * (registers the same `material_index` ID on REFORGED_WAND with the wand's
 * 7-material index space and an across-all-modules max-tier-wins reader).
 */
